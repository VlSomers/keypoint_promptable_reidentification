...
from torchreid.optim.schedulers.cosine_lr import CosineLRScheduler

AVAI_SCH = ['single_step', 'multi_step', 'warmup_multi_step', 'cosine_annealing', 'cosine_annealing_warm_restarts', 'cosine_annealing_warmup']
...
def build_lr_scheduler(
    ...
    elif lr_scheduler == 'cosine_annealing_warm_restarts':
    ...
    elif lr_scheduler == 'cosine_annealing_warmup':
