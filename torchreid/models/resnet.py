...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.spatial_feature_shape = (int(img_size[0]/reduce_factor), int(img_size[1]/reduce_factor), self.feature_dim)  # FIXME dirty fix
...
def resnet18(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
...
def resnet34(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=BasicBlock,
...
def resnet50(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet101(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet152(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnext50_32x4d(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnext101_32x8d(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
...
def resnet50_fc512(num_classes, loss='softmax', pretrained=True, config=None, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        loss=loss,
        block=Bottleneck,
